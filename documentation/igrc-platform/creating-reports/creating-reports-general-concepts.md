...
![Dataset](./images/worddav04be3061b63fd76ff57bd84fe9ee4ab7.png "Dataset")  
...
![Dataset](./images/worddave90f23d566e48fe49e422fc86df3ee4b.png "Dataset")  
...
![Dataset](./images/worddavb46798504c2c88879c16087469bdb2eb.png "Dataset")  
...
![Audit view on dataset](./images/worddav8bbb1bce0f221a15a56557b8a80a2be5.png "Audit view on dataset")  
...
![Audit view on dataset](./images/worddav021fe44dccbdb5bfa7ce88e15717a181.png "Audit view on dataset")  
...
![Audit view on dataset](./images/worddav972fd1699b45b9eb37f7d7b9d0eac9bd.png "Audit view on dataset")  
...
![Audit view on dataset](./images/worddav2fd2118f02b527854818642c222a5c80.png "Audit view on dataset")  
...
![Audit view on dataset](./images/worddav52b67b52df51803f13a318e7c7168139.png "Audit view on dataset")  
...
![Audit view on dataset](./images/worddav4e2965edfc4c3afbbd5ce6b9c17ad942.png "Audit view on dataset")  
...
![Graphical components](./images/worddav347ce16530a2fb15747fab51e5fc99bc.png "Graphical components")  
...
![Text editor](./images/worddava8f12b948a276ec1428e87d0a410031e.png "Text editor")  
**_Text editor_**
...
![Dynamic text editor](./images/worddav21121ebd7115515469071d9f735916cc.png "Dynamic text editor")  
...
![Data editor](./images/worddav62581db2d24b47a8fc4ae727ee1b9a13.png "Data editor")  
**_Data editor_**  
...
![Data editor in the Binding tab](./images/worddavbdbbb04d9555e4ddca1f0c4571b39655.png "Data editor in the Binding tab")  
...
![Selecting image](./images/worddavb87b02c13a5542d43512b680b129caf2.png "Selecting image")  
...
![Creating a table](./images/worddav3b55154939d9579dc4eb090b38a9ac0a.png "Creating a table")  
**_Creating a table_**
...
![List component](./images/worddavf67671e6b9332ba149265380f5dbe0dc.png "List component")  
...
![List component](./images/worddav860b2a6ef28332d09b78dcfdb5dc50ee.png "List component")  
...
![Creating a table](./images/worddav3593dae8fba8b9743cf1869bf8b38c16.png "Creating a table")  
**_Creating a table_**  
...
![Table component](./images/worddavd6597082c36b73f7b0fdb28285aec4a8.png "Table component")  
...
![Creating a chart](./images/worddav965c775dc9d787aa6b0244a2cd13f172.png "Creating a chart")  
**_Creating a chart_**
...
![Creating a data cube](./images/worddavcaffd68fe7fdf8e122e5efa24937e9f7.png "Creating a data cube")  
...
![Series of indicators](./images/worddav8c08f60f880840f4cbd8a65d9e423664.png "Series of indicators")  
**_Representation of a series of indicators_**  

![Creating an indicator](./images/worddav64aadaf7c7d20200ad33e29672cc2879.png "Creating an indicator")  
...
![Creating rotated text](./images/worddavb56f1625775a7cb54f6343549a75a147.png "Creating rotated text")  
...
![Grid cell](./images/worddav8f132cbcb7b622dd104c0a45520cab62.png "Grid cell")  
**_Formatting properties of a Grid cell_**

![Merging cells](./images/worddava8389956b1d2f56ae081a9be6db9ab43.png "Merging cells")  
...
![Padding, Margin, Border](./images/worddav845c2d20e2fb7710d0977a372ecd562f.png "Padding, Margin, Border")  
...
![Text formatting](./images/worddavc959df87c6d2558d55e824191c30794b.png "Text formatting")  
**_Text formatting_**
...
![Managing visibility](./images/worddav35bc779d42e9cba2a4bc84789b545ced.png "Managing visibility")  
...
![Managing visibility with a Javascript script](./images/worddav85783a7e48c61c6f81b970435eba0d20.png "Managing visibility with a Javascript script")  
...
![Managing pagination](./images/worddavf6a1f15676cdc3659b02fe52fe6ee3dd.png "Managing pagination")  
...
![Column values](./images/worddav0d0f8c44dd0ced53d3819a872ad2cdeb.png "Column values")  
...
![Configuring value substitution](./images/worddav112b1ae95c725ae8090360d8b100e787.png "Configuring value substitution")  
...
![Internal attribute](./images/worddav5ebf4db97d71ee34ac3b27e4a1e908b2.png "Internal attribute")  
...
![Conditional layout](./images/worddaveb5bdeb86ff9e444950843779c0af543.png "Conditional layout")  
...
![Conditional formatting](./images/worddav27373aec4078eedc2c2b5ce5d704fa49.png "Conditional formatting")  
...
![Example of Conditional formatting](./images/worddav784a014ae61cc5bb761c420e056fd274.png "Example of Conditional formatting")  
...
![Table of contents](./images/worddavc0f55e321c811c882cabd8f08a3560a5.png "Table of contents")  
...
![Web Viewer](./images/reportpreview.png "Web Viewer")  
**_Web Viewer_**
...
![Sorting data](./images/worddav4432381969ddb6a72d990f2a56a76843.png "Sorting data")  
**_Sorting data_**
...
![Sorting data](./images/worddav9c6dbf33aa66858464610f287b2e91fb.png "Sorting data")  
**_Sorting data_**
...
![Data in a table](./images/worddaveea6683e27091ab73316ea6474965633.png "Data in a table")  
...
![Grouped data](./images/worddav84408c231d040ccaee93bb681139e400.png "Grouped data")  
**_Table with grouped data_**

![_Example Grouped data](./images/worddav563ee74034707f40a767a2f87f63eabd.png "_Example Grouped data")  
...
![Data aggregation and analysis component](./images/worddav564e5f9ad91b86ec4e4d1bcfb3c9ef00.png "Data aggregation and analysis component")  
...
![Data aggregation settings](./images/worddaveea2af00a3bfaeb44c2473e247001219.png "Data aggregation settings")  
**_Data aggregation settings_**  

![Data aggregation settings at the Binding level](./images/worddav21a82b1af0aabca1d094fa15bd1e1cce.png "Data aggregation settings at the Binding level")  
...
![Configuring filters ](./images/worddavb7ffb2c14271abebe5cea220ec14d330.png "Configuring filters ")  
...
![Report settings](./images/worddave344ac87448c0bfa9e8f3243681764fd.png "Report settings")  
...
![Report parameter](./images/worddavdd45d6409b577a770fcb86637bffcead.png "Report parameter")  
...
![Report parameter](./images/Capture.png "Report parameter")  
**_Creating a report parameter_**  
...
![Web interface](./images/worddav62acc19319e060bbf1efda8224be420c.png "Web interface")  
...
![External link](./images/worddav96ef62df811d8e49bf40f3573b66a612.png "External link")  
...
![External link](./images/worddav1317af8934776a4ecf951b3fe41b47fa.png "External link")  
...
![Configuring a hyperlink](./images/worddav6fcdb1453a4331ab0da576e16f292086.png "Configuring a hyperlink")  
