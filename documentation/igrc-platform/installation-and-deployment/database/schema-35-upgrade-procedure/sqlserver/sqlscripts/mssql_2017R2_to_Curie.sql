...
GO
ALTER TABLE tapplication ADD cfstype NVARCHAR(10);
GO
ALTER TABLE tportalapplication ADD cfstype NVARCHAR(10);
...
GO
ALTER TABLE taclaccount ALTER COLUMN caction NVARCHAR(40);


GO
ALTER TABLE taclaccount ALTER COLUMN cbasic NVARCHAR(16);



GO
ALTER TABLE taclgroup ALTER COLUMN caction NVARCHAR(40);


GO
ALTER TABLE taclgroup ALTER COLUMN cbasic NVARCHAR(16);



GO
ALTER TABLE tfsrightgroup ALTER COLUMN caction NVARCHAR(40);


GO
ALTER TABLE tfsrightgroup ALTER COLUMN cbasic NVARCHAR(16);



GO
ALTER TABLE tportalaclaccount ALTER COLUMN caction NVARCHAR(40);


GO
ALTER TABLE tportalaclaccount ALTER COLUMN cbasic NVARCHAR(16);



GO
ALTER TABLE tportalaclgroup ALTER COLUMN caction NVARCHAR(40);


GO
ALTER TABLE tportalaclgroup ALTER COLUMN cbasic NVARCHAR(16);



GO
ALTER TABLE tportalfsrightgroup ALTER COLUMN caction NVARCHAR(40);


GO
ALTER TABLE tportalfsrightgroup ALTER COLUMN cbasic NVARCHAR(16);
...
GO
ALTER TABLE timportaccount ADD cprivilegedaccount NVARCHAR(1);
GO
ALTER TABLE taccount ADD cprivilegedaccount NVARCHAR(1);
GO
ALTER TABLE tportalaccount ADD cprivilegedaccount NVARCHAR(1);
GO
...
CREATE TABLE timportmetadata (
  ...
  cmetadatauid          NVARCHAR(64)   NOT NULL,
  -- Object information
  csilofk               NVARCHAR(64),
  corganisationfk       NVARCHAR(64),
  cidentityfk           NVARCHAR(64),
  crepositoryfk         NVARCHAR(64),
  cgroup1fk             NVARCHAR(64),
  cgroup2fk             NVARCHAR(64),
  caccountfk            NVARCHAR(64),
  cperimeterfk          NVARCHAR(64),
  cpermission1fk        NVARCHAR(64),
  cpermission2fk        NVARCHAR(64),
  capplicationfk        NVARCHAR(64),
  cassetfk              NVARCHAR(64),
  ctorenew              NVARCHAR(1)       NOT NULL,
  corigin               NVARCHAR(1)       NOT NULL,
  ckey                  NVARCHAR(64)   NOT NULL,
  chash                 NVARCHAR(320)  NOT NULL,
  cjointypes            NVARCHAR(32)   NOT NULL,
  cvalue1string         NVARCHAR(400),
  cvalue2string         NVARCHAR(400),
  cvalue1integer        INTEGER,
  cvalue2integer        INTEGER,
  cvalue1double         FLOAT,
  cvalue2double         FLOAT,
  cvalue1date           NVARCHAR(15),
  cvalue1day            INTEGER,
  cvalue2date           NVARCHAR(15),
  cvalue2day            INTEGER,
  cvalueboolean         NVARCHAR(1),
...
GO
ALTER TABLE timportrepository ADD crepositoryfamily NVARCHAR(32);
GO
ALTER TABLE trepository ADD crepositoryfamily NVARCHAR(32);
GO
ALTER TABLE tportalrepository ADD crepositoryfamily NVARCHAR(32);

-- IGRC-2742 Add a field in ticketlog and ticketaction to be able to nationalize the title
GO
ALTER TABLE tticketlog ADD cothertitles NVARCHAR(4000);
GO
ALTER TABLE tticketaction ADD cothertitles NVARCHAR(4000);
...
GO
ALTER TABLE timportapplication ADD capplicationfamily NVARCHAR(32);
GO
ALTER TABLE tapplication ADD capplicationfamily NVARCHAR(32);
GO
ALTER TABLE tportalapplication ADD capplicationfamily NVARCHAR(32);
GO
...
GO
ALTER TABLE timportlog ADD creference NVARCHAR(32);
...
GO
ALTER TABLE timportlog ADD cprogressstatus          NVARCHAR(64);
GO
ALTER TABLE timportlog ADD clastprogressdate        NVARCHAR(15);
GO
ALTER TABLE timportlog ADD clastprogressday         INTEGER;

-- expand reason in exception table
GO
ALTER TABLE texception ALTER COLUMN creason NVARCHAR(4000);



-- expand reason in exception portal table
GO
ALTER TABLE tportalexception ALTER COLUMN creason NVARCHAR(4000);
...
GO
ALTER TABLE tticketlog ADD ccandidatefullnames      NVARCHAR(4000);
...
-- taclaccount, taclgroup, tfsrightgroup, tportalaclaccount, tportalaclgroup, tportalfsrightgroup
GO
ALTER TABLE timportaclaccount ALTER COLUMN caction NVARCHAR(40);


GO
ALTER TABLE timportaclgroup ALTER COLUMN caction NVARCHAR(40);
...
GO
ALTER TABLE tticketaction ADD crevieweruid          NVARCHAR(64);
GO
ALTER TABLE tticketaction ADD creviewerfullname     NVARCHAR(96);
GO
ALTER TABLE tticketaction ADD caccountablefk        INTEGER;
GO
ALTER TABLE tticketaction ADD caccountableuid       NVARCHAR(64);
GO
ALTER TABLE tticketaction ADD caccountablefullname  NVARCHAR(96);
GO
ALTER TABLE tticketaction ADD ccategory             NVARCHAR(250);
GO
...
ALTER TABLE tticketreview DROP CONSTRAINT ticketreview_type_ck;
GO
ALTER TABLE tticketreview ADD cmetadatauid          NVARCHAR(64);
GO
ALTER TABLE tticketreview ADD cparentgroupuid       NVARCHAR(64);
GO
ALTER TABLE tticketreview ADD cparentpermuid        NVARCHAR(64);
GO
ALTER TABLE tticketreview ADD cactorfk              INTEGER;
GO
ALTER TABLE tticketreview ADD cactoruid             NVARCHAR(64);
GO
ALTER TABLE tticketreview ADD cactorfullname        NVARCHAR(96);
GO
ALTER TABLE tticketreview ADD caccountablefk        INTEGER;
GO
ALTER TABLE tticketreview ADD caccountableuid       NVARCHAR(64);
GO
ALTER TABLE tticketreview ADD caccountablefullname  NVARCHAR(96);
GO
ALTER TABLE tticketreview ADD cactiondate           NVARCHAR(15);
GO
ALTER TABLE tticketreview ADD cactionday            INTEGER;
GO
ALTER TABLE tticketreview ADD cvalidfromdate        NVARCHAR(15);
GO
ALTER TABLE tticketreview ADD cvalidfromday         INTEGER;
GO
ALTER TABLE tticketreview ADD cvalidtodate          NVARCHAR(15);
GO
...
GO
ALTER TABLE tmetadata ADD csubkey NVARCHAR(64);
GO
ALTER TABLE tmetadata ADD cmastermetadatafk INTEGER;
GO
ALTER TABLE tmetadata ADD ccharacteristic NVARCHAR(1);
GO
ALTER TABLE tmetadata ADD cactorfk INTEGER;
GO
ALTER TABLE tmetadata ADD cactoruid NVARCHAR(64);
GO
ALTER TABLE tmetadata ADD cactorfullname NVARCHAR(96);
GO
...
CREATE TABLE tmetadatavalue (
  ...
  cmetadatafk           INTEGER       NOT NULL,
  -- Object information
  cvalue1string         NVARCHAR(300),
  cvalue2string         NVARCHAR(300),
  cvalue1integer        INTEGER,
  cvalue2integer        INTEGER,
  cvalue1double         FLOAT,
  cvalue2double         FLOAT,
  ...
  cvalue2day            INTEGER,
  cvalueboolean         NVARCHAR(1),
  cvalueorganisationuid NVARCHAR(64),
  cvalueorganisationfk  INTEGER,
  cvalueidentityuid     NVARCHAR(64),
  cvalueidentityfk      INTEGER,
  cvaluerepositoryuid   NVARCHAR(64),
  cvaluerepositoryfk    INTEGER,
  cvaluegroupuid        NVARCHAR(64),
  cvaluegroupfk         INTEGER,
  cvalueaccountuid      NVARCHAR(64),
  cvalueaccountfk       INTEGER,
  cvalueperimeteruid    NVARCHAR(64),
  cvalueperimeterfk     INTEGER,
  cvaluepermissionuid   NVARCHAR(64),
  cvaluepermissionfk    INTEGER,
  cvalueapplicationuid  NVARCHAR(64),
  cvalueapplicationfk   INTEGER,
  cvalueassetuid        NVARCHAR(64),
...
GO
ALTER TABLE timportmetadata ADD csubkey NVARCHAR(64);
GO
ALTER TABLE timportmetadata ADD cmastermetadatafk NVARCHAR(64);
GO
ALTER TABLE timportmetadata ADD ccharacteristic NVARCHAR(1);
GO
...
CREATE TABLE timportmetadatavalue (
  ...
  cvalue2day            INTEGER,
  cvalueboolean         NVARCHAR(1),
  cvalueorganisationfk  NVARCHAR(64),
  cvalueidentityfk      NVARCHAR(64),
  cvaluerepositoryfk    NVARCHAR(64),
  cvaluegroupfk         NVARCHAR(64),
  cvalueaccountfk       NVARCHAR(64),
  cvalueperimeterfk     NVARCHAR(64),
  cvaluepermissionfk    NVARCHAR(64),
  cvalueapplicationfk   NVARCHAR(64),
  cvalueassetfk         NVARCHAR(64),
  cdetails              NVARCHAR(MAX),
...
GO
ALTER TABLE tportalmetadata ADD csubkey NVARCHAR(64);
GO
ALTER TABLE tportalmetadata ADD cmastermetadatafk INTEGER;
GO
ALTER TABLE tportalmetadata ADD ccharacteristic NVARCHAR(1);
GO
ALTER TABLE tportalmetadata ADD cactorfk INTEGER;
GO
ALTER TABLE tportalmetadata ADD cactoruid NVARCHAR(64);
GO
ALTER TABLE tportalmetadata ADD cactorfullname NVARCHAR(96);
GO
...
CREATE TABLE trawrightgroup (
  ...
  ctimeslotfk           NVARCHAR(64)   NOT NULL,
  -- Object permanent key
  crawrightgroupuid     NVARCHAR(64)   NOT NULL,
  -- Object information
  crepositoryfk         INTEGER       NOT NULL,
  cgroupfk              INTEGER       NOT NULL,
  cpermissionfk         INTEGER       NOT NULL,
  cperimeterfk          INTEGER,
  crighttype            NVARCHAR(32),
  cdisplayname          NVARCHAR(250),
  cnegative             NVARCHAR(1)       NOT NULL,
  cdefault              NVARCHAR(1),
  ccontext              NVARCHAR(250), -- small to be indexable on SQLServer
  ccustom1              NVARCHAR(1000),
  ccustom2              NVARCHAR(1000),
  ccustom3              NVARCHAR(1000),
  ccustom4              NVARCHAR(1000),
  ccustom5              NVARCHAR(1000),
  ccustom6              NVARCHAR(1000),
  ccustom7              NVARCHAR(1000),
  ccustom8              NVARCHAR(1000),
  ccustom9              NVARCHAR(1000),
...
CREATE TABLE timportrawrightgroup (
  ...
  -- Object information
  csilofk               NVARCHAR(64),
  crepositoryfk         NVARCHAR(64)   NOT NULL,
  cgroupfk              NVARCHAR(64)   NOT NULL,
  cpermissionfk         NVARCHAR(64)   NOT NULL,
  cperimeterfk          NVARCHAR(64),
  crighttype            NVARCHAR(32),
  cdisplayname          NVARCHAR(250),
  cnegative             NVARCHAR(1)       NOT NULL,
...
GO
ALTER TABLE taclaccount         ADD cread         NVARCHAR(1);
GO
ALTER TABLE taclaccount         ADD cwrite        NVARCHAR(1);
GO
ALTER TABLE taclaccount         ADD ccontrol      NVARCHAR(1);
...
GO
ALTER TABLE taclgroup           ADD cread         NVARCHAR(1);
GO
ALTER TABLE taclgroup           ADD cwrite        NVARCHAR(1);
GO
ALTER TABLE taclgroup           ADD ccontrol      NVARCHAR(1);
...
GO
ALTER TABLE tportalaclaccount   ADD cread         NVARCHAR(1);
GO
ALTER TABLE tportalaclaccount   ADD cwrite        NVARCHAR(1);
GO
ALTER TABLE tportalaclaccount   ADD ccontrol      NVARCHAR(1);
...
GO
ALTER TABLE tportalaclgroup     ADD cread         NVARCHAR(1);
GO
ALTER TABLE tportalaclgroup     ADD cwrite        NVARCHAR(1);
GO
ALTER TABLE tportalaclgroup     ADD ccontrol      NVARCHAR(1);
...
GO
ALTER TABLE tfsrightgroup       ADD cread         NVARCHAR(1);
GO
ALTER TABLE tfsrightgroup       ADD cwrite        NVARCHAR(1);
GO
ALTER TABLE tfsrightgroup       ADD ccontrol      NVARCHAR(1);
...
GO
ALTER TABLE tportalfsrightgroup ADD cread         NVARCHAR(1);
GO
ALTER TABLE tportalfsrightgroup ADD cwrite        NVARCHAR(1);
GO
ALTER TABLE tportalfsrightgroup ADD ccontrol      NVARCHAR(1);
