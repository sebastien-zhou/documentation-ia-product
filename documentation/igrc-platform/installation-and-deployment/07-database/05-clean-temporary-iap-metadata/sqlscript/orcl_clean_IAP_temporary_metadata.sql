...
rem user : TO REPLACE BY YOUR ORACLE SCHEMA
rem password : TO REPLACE BY YOUR PASSWORD
rem TNS_CONNECT_STRING : YOUR DATABASE TNS CONNECT STRING
rem >@orcl_clean_IAS_temporary_metadata.sql
rem ---------------------------------------------------------------------------
